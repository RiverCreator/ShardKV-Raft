...
static const char* KvRaftServiceRpc_method_names[] = {
  ...
  "/kvrf.KvRaftServiceRpc/Migrate",
  "/kvrf.KvRaftServiceRpc/Ack",
};
...
KvRaftServiceRpc::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_Migrate_(KvRaftServiceRpc_method_names[2], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Ack_(KvRaftServiceRpc_method_names[3], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status KvRaftServiceRpc::Stub::Migrate(::grpc::ClientContext* context, const ::kvrf::MigrationRequest& request, ::kvrf::MigrationResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Migrate_, context, request, response);
}

void KvRaftServiceRpc::Stub::experimental_async::Migrate(::grpc::ClientContext* context, const ::kvrf::MigrationRequest* request, ::kvrf::MigrationResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Migrate_, context, request, response, std::move(f));
}

void KvRaftServiceRpc::Stub::experimental_async::Migrate(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::kvrf::MigrationResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Migrate_, context, request, response, std::move(f));
}

void KvRaftServiceRpc::Stub::experimental_async::Migrate(::grpc::ClientContext* context, const ::kvrf::MigrationRequest* request, ::kvrf::MigrationResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Migrate_, context, request, response, reactor);
}

void KvRaftServiceRpc::Stub::experimental_async::Migrate(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::kvrf::MigrationResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Migrate_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::kvrf::MigrationResponse>* KvRaftServiceRpc::Stub::AsyncMigrateRaw(::grpc::ClientContext* context, const ::kvrf::MigrationRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::kvrf::MigrationResponse>::Create(channel_.get(), cq, rpcmethod_Migrate_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::kvrf::MigrationResponse>* KvRaftServiceRpc::Stub::PrepareAsyncMigrateRaw(::grpc::ClientContext* context, const ::kvrf::MigrationRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::kvrf::MigrationResponse>::Create(channel_.get(), cq, rpcmethod_Migrate_, context, request, false);
}

::grpc::Status KvRaftServiceRpc::Stub::Ack(::grpc::ClientContext* context, const ::kvrf::AckRequest& request, ::kvrf::AckResponse* response) {
  return ::grpc::internal::BlockingUnaryCall(channel_.get(), rpcmethod_Ack_, context, request, response);
}

void KvRaftServiceRpc::Stub::experimental_async::Ack(::grpc::ClientContext* context, const ::kvrf::AckRequest* request, ::kvrf::AckResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Ack_, context, request, response, std::move(f));
}

void KvRaftServiceRpc::Stub::experimental_async::Ack(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::kvrf::AckResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc_impl::internal::CallbackUnaryCall(stub_->channel_.get(), stub_->rpcmethod_Ack_, context, request, response, std::move(f));
}

void KvRaftServiceRpc::Stub::experimental_async::Ack(::grpc::ClientContext* context, const ::kvrf::AckRequest* request, ::kvrf::AckResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Ack_, context, request, response, reactor);
}

void KvRaftServiceRpc::Stub::experimental_async::Ack(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::kvrf::AckResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc_impl::internal::ClientCallbackUnaryFactory::Create(stub_->channel_.get(), stub_->rpcmethod_Ack_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::kvrf::AckResponse>* KvRaftServiceRpc::Stub::AsyncAckRaw(::grpc::ClientContext* context, const ::kvrf::AckRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::kvrf::AckResponse>::Create(channel_.get(), cq, rpcmethod_Ack_, context, request, true);
}

::grpc::ClientAsyncResponseReader< ::kvrf::AckResponse>* KvRaftServiceRpc::Stub::PrepareAsyncAckRaw(::grpc::ClientContext* context, const ::kvrf::AckRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc_impl::internal::ClientAsyncResponseReaderFactory< ::kvrf::AckResponse>::Create(channel_.get(), cq, rpcmethod_Ack_, context, request, false);
}
...
KvRaftServiceRpc::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      KvRaftServiceRpc_method_names[2],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KvRaftServiceRpc::Service, ::kvrf::MigrationRequest, ::kvrf::MigrationResponse>(
          [](KvRaftServiceRpc::Service* service,
             ::grpc_impl::ServerContext* ctx,
             const ::kvrf::MigrationRequest* req,
             ::kvrf::MigrationResponse* resp) {
               return service->Migrate(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      KvRaftServiceRpc_method_names[3],
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< KvRaftServiceRpc::Service, ::kvrf::AckRequest, ::kvrf::AckResponse>(
          [](KvRaftServiceRpc::Service* service,
             ::grpc_impl::ServerContext* ctx,
             const ::kvrf::AckRequest* req,
             ::kvrf::AckResponse* resp) {
...
::grpc::Status KvRaftServiceRpc::Service::Migrate(::grpc::ServerContext* context, const ::kvrf::MigrationRequest* request, ::kvrf::MigrationResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status KvRaftServiceRpc::Service::Ack(::grpc::ServerContext* context, const ::kvrf::AckRequest* request, ::kvrf::AckResponse* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
